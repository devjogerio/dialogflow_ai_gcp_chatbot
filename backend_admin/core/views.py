...
class TicketViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        """
        Sobrescreve o método create para adicionar logs ou lógica customizada 
        ao receber um novo chamado via API.
        """
        # Chama a implementação padrão de criação
        response = super().create(request, *args, **kwargs)
        
        # Aqui poderíamos adicionar lógica extra, como enviar um email para o suporte
